...
- At the end of a session when significant work was completed (see `references/hook-integration.md` for integration notes)
...
- `agent-evaluation` — Evaluation methodology for agentic AI systems and autonomous loops
- `verification-loop` — Systematic verification of outputs against expected results
- `ai-security` — AI/LLM/agent security checklist
