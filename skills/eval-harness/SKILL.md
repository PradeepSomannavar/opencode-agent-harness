---
name: eval-harness
description: Formal evaluation framework for OpenCode agent workflows implementing eval-driven development (EDD) principles. Use when an agent workflow needs a formal eval before it is trusted or changed.
metadata:
  origin: ECC
---
...
### Pre-Implementation
Define an eval block for the feature before implementation.
Creates eval definition file at `evals/feature-name.md`

### During Implementation
Check the feature by running current evals and reporting status.

### Post-Implementation
Generate a full eval report for the feature.
...
### Phase 3: Evaluate
Run the eval check for the feature (e.g., add-authentication).
